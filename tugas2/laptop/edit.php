<?php
$id = $_GET['kd_jual']; include 'model.php';
$model = new Model();
$data = $model->edit($id);
?>
<!doctype html>
...
<input type="hidden" name="kd_jual" value="<?php echo $data->kd_jual ?>">
    <label>Nama Laptop</label>
    
    <input class="form-control" type="hidden" name="kd_laptop" value="<?php echo $data->kd_laptop ?>" readonly>
    <input class="form-control" type="text" name="nm_laptop" value="<?php echo $data->nm_laptop ?>" readonly>
</div>

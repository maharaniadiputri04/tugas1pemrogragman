...
<td><?= $data->stok ?></td>
<td>
<a name="edit" id="edit" href="edit.php?kd_laptop=<?= $data->kd_laptop ?>">Edit</a> /
<a name="hapus" id="hapus" href="proses.php?kd_laptop=<?= $data->kd_laptop ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else { ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <input class="form-control" type="text" name="kd_laptop">
</div>
              <div class="form-group">
                  <label>nama</label>
                      <input class="form-control" type="text" name="nm_laptop">
</div>
                <div class="form-group">
                  <label>jenis</label>
                      <input class="form-control" type="text" name="jn_laptop">
</div>
                          <div class="form-group">
                              <label>harga</label>
